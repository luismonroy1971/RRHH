...
<body>
    ...
    <div class="container">
        ...
        <?php if ($nombreUsuario === $usuario['NOMBRE_USUARIO']): ?>
        <div class="current-user">
            <i class="fas fa-info-circle"></i>
            <span>Está editando su propio usuario. Los cambios de rol pueden afectar sus permisos actuales.</span>
        </div>
        <?php endif; ?>
        ...
        <form action="/usuarios/update/<?= htmlspecialchars($usuario['ID']) ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="help-text">Si no desea cambiar la contraseña, deje este campo en blanco.</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="role-description" class="help-text" style="margin-top: 8px;"></div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mostrar descripción inicial del rol seleccionado
            updateRoleDescription(rolSelect.value);
