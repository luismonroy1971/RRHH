...
<head>
    ...
    <title>Editar Documento | Sistema de Gestión</title>
...
<body>
    ...
    <div class="container">
        <h2><i class="fas fa-file-edit"></i> Editar Documento</h2>
        ...
        <form id="documentoForm" action="/documentos/update" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="codigo" id="codigo" value="<?= htmlspecialchars($CODIGO) ?>" 
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion" id="descripcion" required maxlength="200"><?= htmlspecialchars($DESCRIPCION) ?></textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Inicializar contador de caracteres con el valor actual
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(data => {
                    showAlert(alertSuccess, "Documento actualizado exitosamente");
